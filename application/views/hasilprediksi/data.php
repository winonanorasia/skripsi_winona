...
<div class="card mb-3">
	<div class="card-header">
		<a class="mr-4" href="<?php echo site_url('prediksi/create') ?>"><i class="fas fa-plus"></i> Prediksi Baru</a>
		<a class="mr-4" href="<?php echo site_url('prediksi/perbarui_hasil_terbaik') ?>"><i class="fas fa-sync"></i> Perbarui Hasil Terbaik</a>
