<div class="card mb-3">
    ...
    <div class="card-body">
        <form name="formPred" action="<?php echo base_url('pengujian/uji') ?>" method="post" onsubmit="return validateForm()">
            ...
            <div class="form-group row">
                ...
                <div class="col">
                    <label>Jumlah Folds*</label>
                    <input class="form-control <?php echo form_error('jumlah_folds') ? 'is-invalid':'' ?>"
                        type="number" name="jumlah_folds" min="0" value="<?=set_value('jumlah_folds')?>" 
                        />
                </div>
            </div>
            <div class="form-group row">
